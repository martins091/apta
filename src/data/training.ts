...
export const COURSES: CourseData[] = [
  {
    ...
    hero: "Privacy decisions happen in every team. This course gives your product managers, marketers, HR leads, and customer success teams the vocabulary, instincts, and confidence to make the right calls.",
    ...
    outcomes: [
      ...
      "Speak the same vocabulary as your privacy, security, and compliance counterparts",
    ...
    faqs: [
      { q: "Is this course suitable for non-technical staff?", a: "Yes — it's specifically designed for everyone. We use everyday language and real examples drawn from marketing, product, and HR workflows." },
  ...
  },
  {
    ...
    tag: "New for 2026",
    tagline: "Ship AI features your privacy, security, and compliance teams can actually defend.",
    format: "Live virtual or on-site",
    level: "Intermediate",
    summary: "A hands-on workshop for teams putting LLMs, agents, and ML into production.",
    hero: "The regulation is moving. Your team is moving faster. This bootcamp closes the gap — giving product and technical leads the AI governance toolkit they need to build responsibly without slowing the roadmap.",
    audience: "Product managers, technical leads, ML/AI practitioners, security, and privacy professionals adopting GenAI.",
    outcomes: [
      "Map AI risks against the EU AI Act, NIST AI RMF, and emerging US state rules",
      "Run a defensible model and vendor risk review effectively",
    ...
    modules: [
      ...
      },
      {
        ...
        bullets: ["Writing an AI AUP your teams won't ignore", "Disclosure, opt-outs, and user-facing transparency", "Building a lightweight AI review board", "Embedding AI review into your RFC and PRD process"],
      },
    ],
    faqs: [
      { q: "Do participants need a specific background?", a: "No. This is designed for practitioners — product managers and data scientists — not just compliance professionals. We translate the law into decisions your team actually has to make." },
      { q: "Can we bring in our compliance team alongside product teams?", a: "We encourage it. Mixed cohorts of product + compliance + security generate the most valuable conversations. We design exercises that work across functions." },
  ...
  },
  {
    ...
    tagline: "An operator sprint through the GDPR — with a graded capstone.",
    format: "Live virtual cohort",
    level: "Advanced",
    summary: "An operator-focused sprint through the GDPR — built for the people who actually make compliance happen.",
    hero: "This course is built for the DPOs, privacy program leads, and senior product managers who have to operationalise it. Real work. A graded capstone. A certificate you've earned.",
    audience: "Privacy program leads, DPOs in training, compliance professionals, security leads, and senior PMs.",
    outcomes: [
    ...
    faqs: [
      { q: "Is this course a substitute for professional certification?", a: "No — our certificate is a practical operations credential, not a formal certification. Many of our graduates use this course as preparation for professional exams." },
      { q: "What's the workload between sessions?", a: "Expect preparation time between sessions. The capstone takes additional time over the final period." },
      { q: "Can we run a private cohort for our organisation?", a: "Yes. Private cohorts are available for organisations with multiple participants. We can also customise the case studies around your specific industry and data posture." },
    ],
    icon: GraduationCap,
  },
  {
    ...
    hero: "Your board is being asked to sign off on AI initiatives, data strategies, and privacy budgets — without the context to evaluate them. We fix that in a focused session.",
    audience: "CEOs, COOs, compliance leaders, CFOs, board members, and executive leadership teams.",
    outcomes: [
    ...
    faqs: [
      { q: "How do you prepare the briefing for our specific organisation?", a: "Before the session, we conduct an intake call with your primary contact to understand your industry, data posture, current programme maturity, and the key decisions the board is facing. The briefing is then tailored around those specifics." },
      ...
      { q: "Is a single session enough?", a: "For executives, yes. We've found that focused sessions produce better engagement and retention than lengthy workshops. For teams that want to go deeper, we recommend following up with the AI Governance Bootcamp for relevant team members." },
    ],
    icon: Briefcase,
  },
{
  ...
  tag: "Hands-on",
  tagline: "Build a repeatable DSAR workflow your team can run with confidence.",
  format: "Live virtual or on-site",
  level: "Intermediate",
  ...
  audience: "Privacy ops, customer support leads, and IT teams handling user data requests.",
  outcomes: [
  ...
  modules: [
    ...
    },
    {
      ...
      bullets: ["Mapping where personal data actually lives across your systems", "Working with teams to build self-service tooling", "Collecting from databases, SaaS tools, email, and backups", "Third-party data — what you must disclose and what you can redact"],
    },
    {
  ...
  faqs: [
    ...
    { q: "Can we get just the templates without the full workshop?", a: "Our templates are designed to be used in conjunction with the training — the process decisions behind them matter as much as the documents themselves. We don't sell templates in isolation." },
  ],
  icon: FileSearch,
},
  {
    ...
    format: "Live virtual or on-site",
    level: "Intermediate",
    summary: "A practical workshop that embeds privacy into the way your product teams already work.",
    hero: "Privacy bolted on after launch costs 10x more than privacy baked in from the start. This workshop gives your product teams the tools to make privacy-safe the default — inside your existing sprint, RFC, and design-doc processes.",
    audience: "Product managers, technical managers, designers, and platform/security professionals.",
    outcomes: [
      ...
      "Build internal tools that make the privacy-safe path the easy path",
      "Avoid the costly rebuilds that come from privacy decisions made too late",
      "Run a privacy review for any new feature or data flow",
    ],
    modules: [
      {
        title: "Module 1 — Privacy as a System Property",
        bullets: ["Data flow diagramming — the right level of detail", "Minimisation, purpose limitation, and retention baked into schema design", "The cost of retrofitting vs. designing right the first time", "Where privacy debt hides in a typical SaaS product"],
      },
      {
        title: "Module 2 — Designing Reviewable Features",
        bullets: ["Privacy questions in the PRD and design doc", "The privacy review for product teams", "When to escalate to compliance — and when not to", "A worked example: redesigning an analytics feature for privacy"],
      },
      {
        title: "Module 3 — Tooling & Defaults",
        bullets: ["Building internal SDKs for logging, analytics, and consent", "Deletion, anonymisation, and the right-to-be-forgotten pipeline", "Access controls, data classification, and audit logging by default", "Making privacy the path of least resistance for your teams"],
      },
    ],
    faqs: [
      ...
      { q: "Does this require any pre-reading or preparation?", a: "None required. We send an optional pre-read (a data flow primer) for those who want to come prepared, but the workshop is fully self-contained." },
